...
│       └── colorModels/
│           ├── index.js      (public API: generateShades)
...
2.3 Behavioural Rules
	1.	Base placement
The input colour appears at or near the perceptual midpoint of the shades.
...
5.2 Preview Panel
	•	Displays tonal shades as swatches
	•	Shows hex values
...
Constraints
	...
	•	Single CSS file (plain CSS, no preprocessor)
